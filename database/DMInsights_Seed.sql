...
BEGIN
    ...
    INSERT INTO [dbo].[Campaigns]
        ([Title], [Description], [ConnectionID], [OwnerId])
    VALUES
        ('Curse of Strahd', 'Vampire slaying at it''s best', '262cdab8-6f69-493e-bf71-5da5fb8063f9', 2)

    INSERT INTO [dbo].[Campaigns]
        ([Title], [Description], [ConnectionID], [OwnerId])
    VALUES
        ('Tomb of Annihilation', 'Yo dawg, I heard you like traps', 'c4238c70-b74c-44a2-953a-93dd0e5cd3f5', 1)

    INSERT INTO [dbo].[Campaigns]
        ([Title], [Description], [ConnectionID], [OwnerId])
    VALUES
        ('Horde of the Dragon Queen', 'Cultists, Why''d it have to be cultists', 'd08697e2-e57c-48fd-ab78-04d8ba0bb753', 2)

    INSERT INTO [dbo].[Campaigns]
        ([Title], [Description], [ConnectionID], [OwnerId])
    VALUES
        ('Storm Kings Thunder', 'Dragons and Giants, YIKES!', 'f4722b0f-023f-4488-937b-627420b30d16', 3)
END
